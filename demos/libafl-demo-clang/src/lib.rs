...
use fandango_targets::scriptsizec::nonterminal_start;
use libafl::{
    Error,
...
/// Optional libFuzzer hook for custom mutation.
/// This is a stub implementation that returns the original size (no mutation).
#[unsafe(no_mangle)]
pub extern "C" fn LLVMFuzzerCustomMutator(
    ...
    // Return original size to indicate no mutation was performed
    size
}

/// Optional libFuzzer hook for custom crossover.
/// This is a stub implementation that returns 0 to indicate it's not used.
#[unsafe(no_mangle)]
pub extern "C" fn LLVMFuzzerCustomCrossOver(
    _data1: *const u8,
    _size1: usize,
    _data2: *const u8,
    _size2: usize,
