...
Some sections of the code are adaptations of [LibAFL](https://github.com/AFLplusplus/LibAFL/releases/tag/0.13.1),
which is similarly licensed, for which license files are provided in [fandango/src/libafl](core/src/libafl).